                    ...
                    (function (JSESCPOSBuilder) {
                        class Document {
                            ...
                            drawLine(new_line = false) {
                                ...
                                image(canvas) {
                                    let image = new JSESCPOSBuilder.ESCPOSImage(canvas);

                                    let header = [29, 118, 48, 0];

                                    let raster = image.toRaster();

                                    let buffer = [ header, raster.width, raster.height, raster.data];
                                    ...
                                    (function (JSESCPOSBuilder) {
                                        ...
                                        class ESCPOSImage {
                                            constructor(canvas) {
                                                ...
                                                console.log('unique', temp_arr.flatMap((pixel) => {
                                            ...
                                            toRaster() {
                                                ...
                                                return {
                                                    data: result,
                                                    width: JSESCPOSBuilder.Utils.int16ToArray(n),
                                                    height: JSESCPOSBuilder.Utils.int16ToArray(height)
                                                };
                                            }
                                        }
